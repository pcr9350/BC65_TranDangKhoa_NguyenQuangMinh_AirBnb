...
const Header = () => {
  ...
  >
      ...
      >
          <ul className="navbar-nav me-auto mb-2 mb-md-0">
            <li className="nav-item mx-3">
              <Link className="nav-link nav-link-header text-center text-primary active" aria-current="page" href="/">Home</Link>
            </li>
            <li className="nav-item mx-3">
              <Link className="nav-link nav-link-header text-center" href="/admin">About</Link>
            </li>
          ...
          <li className="nav-item dropdown">
            <button
              className="btn btn-link nav-link-header dropdown-toggle" // Button-like link
